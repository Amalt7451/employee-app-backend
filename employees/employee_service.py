...
from employees.employee_repo import check_email_exists_repo, get_employee_by_id_repo, update_employee_repo

async def create_employee(db: AsyncSession,name:str,email:str,age:int,salary:int,password:str,role:str,country:str,city:str,zipcode:str)->Employee:
    ...
    employee= await employee_repo.create_employee(db,name.strip(),email.strip(),age,salary,hashed,role,country,city,zipcode)
    return employee
