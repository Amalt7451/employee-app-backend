...
from departments.departments_schema import DepartmentCreate,DepartmentResponse,DepartmentResponseID,DepartmentUpdate
from departments.departments_service import create_department_service, get_all_department_service,get_department_by_id_service,update_department_service,delete_department_service
...
@router.patch("/{id}",status_code=status.HTTP_200_OK,response_model=DepartmentResponse)
async def update_department(body:DepartmentUpdate,id:int,db:AsyncSession=Depends(get_db)):
